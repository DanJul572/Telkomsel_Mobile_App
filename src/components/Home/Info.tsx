    ...
    return (
        <View>
            ...
            <View style={styles.sim_container}>
                <ImageBackground
                    source={require('../../assets/Images/Home/sim_card.png')}
                    style={styles.sim_background}
                    resizeMode="contain">
                    ...
                    <View style={styles.credit_container}>
                        <View>
                            <Text style={styles.credit_label}>
                                Sisa Pulsa Anda
                            </Text>
                    ...
                    <View style={styles.expired_point_container}>
                        <View style={styles.expired_container}>
                            <Text style={styles.expired_label}>
                                Berlaku Sampai{' '}
                            </Text>
